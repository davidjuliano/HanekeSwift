...
public extension UIImageView {
	...
	public func hnk_setImageFromURL(URL: NSURL, includingQueryStringInKey: Bool, placeholder : UIImage? = nil, format : Format<UIImage>? = nil, failure fail : ((NSError?) -> ())? = nil, success succeed : ((UIImage) -> ())? = nil) {
		let fetcher = NetworkFetcher<UIImage>(URL: URL, includingQueryStringInKey: includingQueryStringInKey)
		self.hnk_setImageFromFetcher(fetcher, placeholder: placeholder, format: format, failure: fail, success: succeed)
	}
